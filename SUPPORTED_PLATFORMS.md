...
Aurora 0.1 is a technical preview with this supported distribution matrix:
...
Windows, musl Linux, cross-compilation, and other architectures are not supported by the 0.1 archives. Source builds on those hosts are experimental until they have CI, runtime-link manifests, and packaged-archive smoke tests.
