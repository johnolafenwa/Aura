...
Aura 0.3.1 is a technical preview. The compiler, command-line tools, editor
...
`0.3.1`. The extension needs the `aura` executable on `PATH` because semantic
...
[`aura-language.vsix`](https://github.com/johnolafenwa/Aura/releases/download/v0.3.1-preview/aura-language.vsix)
