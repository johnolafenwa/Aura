...
`semantic_interface_version: 12` plus string fields `method`, `path`, and
...
`semantic_interface_version: 12`, and either `result` or an `error` string.
