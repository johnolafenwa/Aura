...
`semantic_interface_version: 11` plus string fields `method`, `path`, and
...
`semantic_interface_version: 11`, and either `result` or an `error` string.
