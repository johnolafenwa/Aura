...
`semantic_interface_version: 13` plus string fields `method`, `path`, and
...
`semantic_interface_version: 13`, and either `result` or an `error` string.
