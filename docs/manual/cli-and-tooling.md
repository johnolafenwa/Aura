...
`semantic_interface_version: 14` plus string fields `method`, `path`, and
...
`semantic_interface_version: 14`, and either `result` or an `error` string.
