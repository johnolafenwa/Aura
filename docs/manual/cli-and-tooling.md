...
`semantic_interface_version: 10` plus string fields `method`, `path`, and
...
`semantic_interface_version: 10`, and either `result` or an `error` string.
