...
closure environments remain the explicitly disclosed boxed interim until
the next pull request of the representation phase lands the ratified
Q15 A / Q16 A callable layout; no FFI/ABI stability claim and no 0.4 release
precede that. A `TaskCallable[...]` value is a stored task
