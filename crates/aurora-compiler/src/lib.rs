...
pub mod native_runtime_coverage {
    ...
    pub use super::native_runtime::{
        aurora_direct_arg_buffer_new, aurora_direct_binary_value, aurora_direct_binary_value_at,
        aurora_direct_box_bool, aurora_direct_box_i64, aurora_direct_box_u64,
        ...
        aurora_direct_fs_read_dir, aurora_direct_host_builtin, aurora_direct_http_listener_accept,
