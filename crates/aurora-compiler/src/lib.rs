...
pub mod native_runtime_coverage {
    ...
    pub use super::native_runtime::{
        ...
        aurora_direct_integer_to_float, aurora_direct_io_flush, aurora_direct_io_write,
        ...
        aurora_direct_map_values, aurora_direct_monotonic_time_ms, aurora_direct_net_connect,
        aurora_direct_net_http_listen, aurora_direct_net_http_request_bytes_timeout,
        aurora_direct_net_listen, aurora_direct_net_udp_bind, aurora_direct_net_unix_connect,
        aurora_direct_net_unix_listen, aurora_direct_net_websocket_connect,
        aurora_direct_net_websocket_listen, aurora_direct_process_child_close,
        aurora_direct_process_child_stderr, aurora_direct_process_child_stdin,
        aurora_direct_process_child_stdout, aurora_direct_process_child_wait,
        aurora_direct_process_child_wait_ok, aurora_direct_process_child_wait_or_none,
        aurora_direct_process_completed_check, aurora_direct_process_completed_status,
        aurora_direct_process_completed_stderr, aurora_direct_process_completed_stderr_bytes,
        aurora_direct_process_completed_stdout, aurora_direct_process_completed_stdout_bytes,
        aurora_direct_process_completed_success, aurora_direct_process_null,
        aurora_direct_process_pipe, aurora_direct_process_pipe_close,
        ...
        aurora_direct_vec_slice, aurora_direct_vec_swap_in_place,
