...
pub mod native_runtime_coverage {
    ...
    pub use super::native_runtime::{
        aurora_direct_arg_buffer_new, aurora_direct_arg_buffer_store_owned,
        aurora_direct_array_binary, aurora_direct_array_clone, aurora_direct_array_fill_in_place,
        aurora_direct_array_from_vec, aurora_direct_array_full, aurora_direct_array_get,
        aurora_direct_array_index, aurora_direct_array_len, aurora_direct_array_map,
        aurora_direct_array_reduce, aurora_direct_array_set_in_place,
        aurora_direct_array_set_index_in_place, aurora_direct_array_shape,
        aurora_direct_array_slice, aurora_direct_array_zeros, aurora_direct_binary_value,
        aurora_direct_binary_value_at, aurora_direct_box_bool, aurora_direct_box_f64,
        aurora_direct_box_i32, aurora_direct_box_i64, aurora_direct_box_u64,
        aurora_direct_cast_float_to_integer, aurora_direct_cast_integer_to_float,
        aurora_direct_cast_integer_to_integer, aurora_direct_cast_value, aurora_direct_channel_new,
        ...
        aurora_direct_coverage_clone_value, aurora_direct_duration_from_i64,
        aurora_direct_duration_literal, aurora_direct_duration_to_float,
        ...
        aurora_direct_fs_read_dir, aurora_direct_function_default_binder,
        ...
        aurora_direct_http_response_status, aurora_direct_http_response_text,
        aurora_direct_instance_get_field, aurora_direct_instance_new,
        aurora_direct_integer_to_float, aurora_direct_integer_width_binary, aurora_direct_io_flush,
        ...
        aurora_direct_select, aurora_direct_set_contains, aurora_direct_set_empty,
        aurora_direct_set_index_option, aurora_direct_set_insert_in_place,
        aurora_direct_set_is_empty, aurora_direct_set_len, aurora_direct_set_remove_in_place,
        aurora_direct_sleep_ms, aurora_direct_sleep_value, aurora_direct_sleep_value_void,
        aurora_direct_string_byte_len, aurora_direct_string_len, aurora_direct_string_literal,
        aurora_direct_string_slice, aurora_direct_tcp_listener_accept,
        ...
        aurora_direct_unbox_f64, aurora_direct_unbox_i64, aurora_direct_unbox_int64,
        aurora_direct_unbox_u64, aurora_direct_unix_listener_accept,
        ...
        aurora_direct_vec_set_index_in_place, aurora_direct_vec_slice,
