...
pub mod native_runtime_coverage {
    ...
    pub use super::native_runtime::{
        ...
        aurora_direct_duration_literal, aurora_direct_enum_variant, aurora_direct_file_close,
        ...
        aurora_direct_map_set_index_in_place, aurora_direct_map_values, aurora_direct_net_connect,
        ...
        aurora_direct_sleep_ms, aurora_direct_string_byte_len, aurora_direct_string_len,
