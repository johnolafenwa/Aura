...
pub(crate) const BLOCKING_WORKERS_ENV: &str = "AURORA_BLOCKING_WORKERS";
pub(crate) const BLOCKING_QUEUE_CAPACITY_ENV: &str = "AURORA_BLOCKING_QUEUE_CAPACITY";
...
mod tests {
    ...
    fn blocking_io_pool_config_rejects_every_invalid_value_class_for_each_setting() {
        ...
        for (name, workers, capacity) in [
            ("AURORA_BLOCKING_WORKERS", Some(""), None),
            ("AURORA_BLOCKING_WORKERS", Some("0"), None),
            ("AURORA_BLOCKING_WORKERS", Some("+1"), None),
            ("AURORA_BLOCKING_WORKERS", Some("-1"), None),
            ("AURORA_BLOCKING_WORKERS", Some(" 1"), None),
            ("AURORA_BLOCKING_WORKERS", Some("1 "), None),
            ("AURORA_BLOCKING_WORKERS", Some("1.0"), None),
            ("AURORA_BLOCKING_WORKERS", Some("١"), None),
            ("AURORA_BLOCKING_QUEUE_CAPACITY", None, Some("")),
            ("AURORA_BLOCKING_QUEUE_CAPACITY", None, Some("0")),
            ("AURORA_BLOCKING_QUEUE_CAPACITY", None, Some("+1")),
            ("AURORA_BLOCKING_QUEUE_CAPACITY", None, Some("-1")),
            ("AURORA_BLOCKING_QUEUE_CAPACITY", None, Some(" 1")),
            ("AURORA_BLOCKING_QUEUE_CAPACITY", None, Some("1 ")),
            ("AURORA_BLOCKING_QUEUE_CAPACITY", None, Some("1.0")),
            ("AURORA_BLOCKING_QUEUE_CAPACITY", None, Some("١")),
        ] {
        ...
        for (name, workers, capacity) in [
            ("AURORA_BLOCKING_WORKERS", Some(overflow.as_str()), None),
            (
    ...
    fn blocking_io_pool_config_rejects_non_unicode_values_for_each_setting() {
        ...
        for (name, workers, capacity) in [
            ("AURORA_BLOCKING_WORKERS", Some(invalid), None),
            ("AURORA_BLOCKING_QUEUE_CAPACITY", None, Some(invalid)),
        ] {
