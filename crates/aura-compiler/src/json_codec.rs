...
const JSON_ALLOCATION_FAILED_SENTINEL: &str = "__aura_json_allocation_failed__";
const JSON_MATERIALIZATION_TOO_LARGE_SENTINEL: &str = "__aura_json_materialization_too_large__";
